...
CONSTRAINT artist_state_constraint CHECK(state IN ('MA', 'NH', 'VT', 'CT', 'ME', 'RI', 'NY', 'CA', 'OR', 'WA'))
...
CONSTRAINT building_isNotEmpty check(building != '')
);
...
CONSTRAINT ticketPrice_price CHECK (ticketPrice >= 50)
);
...
CONSTRAINT artwork_YN CHECK (purchased IN ('n', 'y')),
...
CONSTRAINT artwork_Materials_FK foreign key (materialsID) references Materials (materialsID),
...
insert into Artwork values(2009,1,15,'Ships in Harbor',505,250,31,'n','12-FEB-23','Dreier');
...
insert into Artwork values(2009,10,365,'Small House',250,145,null,'y','04-NOV-09','Dreier');
...
insert into Artwork values(2010,14,905,'Sunset Over Narrangansett Bay',805,150,null,'y','28-AUG-2010','East');
